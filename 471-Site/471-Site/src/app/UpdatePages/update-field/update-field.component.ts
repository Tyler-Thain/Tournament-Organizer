...
@Component({
  ...
  <div class="box">
  <form #updateFieldForm = "ngForm" (ngSubmit) = "OnSubmit(updateFieldForm)">
    Field Update
        <div class="field">
        <label class="label">
        Enter an Existing Field Number
        </label>
...
.subscribe((data: any) => {
  ...
  OnSubmit(form: NgForm){
    console.log(this.Field.fieldNo, this.Field.gameID, this.Field.parkID, this.Field.sport);
    this.fService.updateField(this.Field.fieldNo, this.Field.gameID, this.Field.parkID, this.Field.sport)
      .subscribe((date: any) => {
        this.ResetForm()
      });
  }
