...
import { tournIDGame } from '../view-game1/view-game1.component';
@Component({
  selector: 'app-view-game2',
  template: `
  ...
  <form #viewFieldForm = "ngForm">
    ...
    <table class = "table table-bordered table-striped">
      ...
      <tbody>
        ...
        <div class="buttons">
        <button class="button is-primary is-fullwidth" routerLink ="/gameLanding">
        Back
        </button>
        </div>
    </form>
...
export class ViewGame2Component implements OnInit {
  Game: game[]
  constructor(private gService: gameServices) { }

  ngOnInit(): void {
    this.gService.getGameByTournament(tournIDGame)
      .subscribe((data: any) => {
