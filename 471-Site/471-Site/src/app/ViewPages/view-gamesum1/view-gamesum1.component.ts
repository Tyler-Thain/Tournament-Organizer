...
export var tournIDGameSum: number;
@Component({
  selector: 'app-view-gamesum1',
  template: `
...
export class ViewGamesum1Component implements OnInit {
  ...
  OnSubmit(form: NgForm){
    tournIDGameSum = this.Tournament.id;
    this.router.navigate(['/gameSumView']);
  }
}
