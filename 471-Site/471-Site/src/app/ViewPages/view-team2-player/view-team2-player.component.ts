...
import { tournIDTeamPlayer } from '../view-team1-player/view-team1-player.component';

@Component({
  selector: 'app-view-team2-player',
  template: `
  <section class="hero is-bold is-fullheight">
  <div class="hero-body">
  <div class="container has-text-centered">
  <div class="box">
  <form #viewTeamPForm = "ngForm">
    ...
    <table class = "table table-bordered table-striped">
      ...
      <tbody>
        ...
        <div class="buttons">
        <button class="button is-primary is-fullwidth" routerLink ="/playerTeamLanding">
        Back
        </button>
        </div>
    </form>
...
export class ViewTeam2PlayerComponent implements OnInit {
  Team:team[]
  constructor(private tService:teamServices) { }

  ngOnInit(): void {
    this.tService.getTeamsByTournament(tournIDTeamPlayer)
    .subscribe((data: any) => {
