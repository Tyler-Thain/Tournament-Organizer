...
export var tournIDGamePlayer: number;

@Component({
  selector: 'app-view-game1-player',
  template: `
...
export class ViewGame1PlayerComponent implements OnInit {
  ...
  OnSubmit(form:NgForm){
    tournIDGamePlayer = this.Tournament.id;
    this.router.navigate(['/gamePlayerView'])
  }
}
